    ...
    <div ref={cardRef} className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
      ...
      <div className={`relative overflow-hidden rounded-3xl border ${s.border} ${s.bg} p-6 sm:p-9`}>
        <div className="flex items-center gap-3">
          ...
          <span className={`risk-pill ${s.badge}`}>
            Risk level
          </span>
        </div>
        ...
        {result.matchedPattern && (
          <Link
            href={result.matchedPattern.href}
          ...
          >
            ...
            Looks like: {result.matchedPattern.label}
            ...
            {result.reasons.map((r, i) => (
              <li
                ...
                style={{
                  ...
                  transform: i < reasonsRevealed ? "translateY(0)" : "translateY(6px)",
                }}
              >
                <span
                  aria-hidden
      ...
      <div className="space-y-4">
        <div className="card">
          ...
          <ul className="mt-3 space-y-3">
            {result.whatToDo.map((step, i) => (
              <li key={step} className="flex items-start gap-3 text-[15px] leading-7">
        ...
        <ShareToTrustedPerson input={input} result={result} />
